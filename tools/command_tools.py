...
sandbox. `use_command` loads a workflow's instructions; it executes nothing itself.
"""
import plugins
...
@registry.register(
    ...
    description=(
        ...
        "run anything. To run a shell command in the sandbox, use run_command instead.)"
    ),
